function Footer() {
  return (
    <footer className="bg-[#2C2C2C] text-white border-t border-gray-700 mt-auto">
      <div className="max-w-[1400px] mx-auto px-8 py-12">
        <div className="flex justify-center gap-4 mb-8">
          <div className="w-52">
            <div className="flex items-center gap-3 mb-4">
              <img 
                ...
                className="w-12 h-12"
              />
              <span className="text-orange-500 text-2xl font-logo tracking-wide">
                Itadaki
              </span>
            </div>
          ...
          <div className="flex items-center">
            <div className="flex items-center gap-7 text-sm">
              ...
              <a href="/my-recipes" className="text-gray-400 hover:text-white transition">
                My Recipes
              </a>
              <a href="/search" className="text-gray-400 hover:text-white transition">
                Search
              </a>
              <a href="/account" className="text-gray-400 hover:text-white transition">
                Account Settings
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-gray-700 pt-6">
          <p className="text-gray-400 text-sm text-center">
            © 2025 Itadaki. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
